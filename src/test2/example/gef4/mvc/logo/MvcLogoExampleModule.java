...
import test2.example.gef4.mvc.logo.behaviors.PaletteFocusBehavior;
import test2.example.gef4.mvc.logo.parts.FXCreateCurveHoverHandlePart;
import test2.example.gef4.mvc.logo.parts.FXDeleteHoverHandlePart;
...
import test2.example.gef4.mvc.logo.parts.FXLogoContentPartFactory;
import test2.example.gef4.mvc.logo.parts.FXLogoHoverHandlePartFactory;
import test2.example.gef4.mvc.logo.parts.FXLogoPaletteContentPartFactory;
import test2.example.gef4.mvc.logo.parts.FXLogoSelectionHandlePartFactory;
import test2.example.gef4.mvc.logo.parts.PaletteElementPart;
import test2.example.gef4.mvc.logo.parts.PaletteModelPart;
import test2.example.gef4.mvc.logo.policies.CloneCurvePolicy;
import test2.example.gef4.mvc.logo.policies.CloneShapePolicy;
import test2.example.gef4.mvc.logo.policies.ContentRestrictedChangeViewportPolicy;
import test2.example.gef4.mvc.logo.policies.CreateAndTranslateOnDragPolicy;
import test2.example.gef4.mvc.logo.policies.FXCloneOnClickPolicy;
import test2.example.gef4.mvc.logo.policies.FXCreateCurveOnDragPolicy;
import test2.example.gef4.mvc.logo.policies.FXCreationMenuItemProvider;
import test2.example.gef4.mvc.logo.policies.FXCreationMenuOnClickPolicy;
import test2.example.gef4.mvc.logo.policies.FXDeleteFirstAnchorageOnClickPolicy;
import test2.example.gef4.mvc.logo.policies.FXRelocateLinkedOnDragPolicy;
