 ...
 *
 *******************************************************************************/
package test2.example.gef4.mvc.logo.model;
...
public class FXGeometricModel {
	...
	// selection handles
	private final FXGeometricShape topLeftSelectionHandle = new FXGeometricShape(createHandleShapeGeometry(),
			new AffineTransform(1, 0, 0, 1, 12, 15), Color.WHITE, GEF_SHADOW_EFFECT);
	private final FXGeometricShape topRightSelectionHandle = new FXGeometricShape(createHandleShapeGeometry(),
			new AffineTransform(1, 0, 0, 1, 243, 15), Color.WHITE, GEF_SHADOW_EFFECT);

	private final FXGeometricShape bottomLeftSelectionHandle = new FXGeometricShape(createHandleShapeGeometry(),
			new AffineTransform(1, 0, 0, 1, 12, 109), Color.WHITE, GEF_SHADOW_EFFECT);

	private final FXGeometricShape bottomRightSelectionHandle = new FXGeometricShape(createHandleShapeGeometry(),
	...
	private final FXGeometricShape gTopShape = new FXGeometricShape(createGTopShapeGeometry(),
			new AffineTransform(1, 0, 0, 1, 27, 22), GEF_COLOR_BLUE, GEF_SHADOW_EFFECT);

	private final FXGeometricShape gMiddleShape = new FXGeometricShape(createGMiddleShapeGeometry(),
			new AffineTransform(1, 0, 0, 1, 27, 22), GEF_COLOR_BLUE, GEF_SHADOW_EFFECT);

	// e shape
	private final FXGeometricShape eShape = new FXGeometricShape(createEShapeGeometry(),
			new AffineTransform(1, 0, 0, 1, 100, 22), GEF_COLOR_BLUE, GEF_SHADOW_EFFECT);

	// f shape
	private final FXGeometricShape fShape = new FXGeometricShape(createFShapeGeometry(),
			new AffineTransform(1, 0, 0, 1, 175, 22), GEF_COLOR_BLUE, GEF_SHADOW_EFFECT);

	// gDotShape
	private final FXGeometricShape gDotShape = new FXGeometricShape(createDotShapeGeometry(),
			new AffineTransform(1, 0, 0, 1, 87, 104), GEF_COLOR_BLUE, GEF_SHADOW_EFFECT);

	// eDotShape
	private final FXGeometricShape eDotShape = new FXGeometricShape(createDotShapeGeometry(),
			new AffineTransform(1, 0, 0, 1, 170, 104), GEF_COLOR_BLUE, GEF_SHADOW_EFFECT);

	// fDotShape
	private final FXGeometricShape fDotShape = new FXGeometricShape(createDotShapeGeometry(),
			new AffineTransform(1, 0, 0, 1, 225, 104), GEF_COLOR_BLUE, GEF_SHADOW_EFFECT);

	// fDotShape
	private final FXGeometricShape cursorShape = new FXGeometricShape(createCursorShapeGeometry(),
