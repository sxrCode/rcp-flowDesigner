 ...
 *
 *******************************************************************************/
package test2.example.gef4.graph;
...
public final class GraphBuilderExample {
	...
	public static void main(final String[] args) {
		...
		Graph g1 = new Graph.Builder().attr(DotAttributes._TYPE__G, DotAttributes._TYPE__G__DIGRAPH)//
				.node("n1")//
		...
		Graph g2 = new Graph.Builder().attr(DotAttributes._TYPE__G, DotAttributes._TYPE__G__DIGRAPH)//
				...
				.attr(DotAttributes.LABEL__GNE, "3")//
				.attr(DotAttributes.ID__GNE, "3")//
				.edge("n1", "n2").attr(DotAttributes.LABEL__GNE, "e1").edge("n1", "n3").build();
		...
		Graph g3 = new Graph.Builder().attr(DotAttributes._TYPE__G, DotAttributes._TYPE__G__DIGRAPH).nodes(n1, n2, n3)//
				.edge(n1, n2)//
				.edge(n1, n3)//
				.build();
	}
